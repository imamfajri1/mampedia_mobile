...
import 'package:mampedia_mobile/screens/product_detail.dart';
          ...
          if (snapshot.data == null) {
            ...
            if (!snapshot.hasData) {
              return const Column(
                children: [
                  Text(
                    'Belum ada data product pada mampedia.',
                    style: TextStyle(fontSize: 20, color: Color.fromARGB(255, 64, 79, 30)),
                  ),
                  SizedBox(height: 8),
                ],
              );
